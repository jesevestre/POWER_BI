...
GROUP BY FA.VENDEUR, C.VENDEUR, V.NOM, C.GROUPE, GRP.DESIGNATION, SGR.DESIGNATION, C.CDE_CENTRALE, 
CEN.DESIGNATION, C.SECTEUR_COMMERCIAL, SEC.LIB_50, C.ACTIVITE, C.CDE_CLI, C.NOM_CLI, AR.LIG_PROD, 
LP.LIB_30, AR.FAM_PROD, PR.LIB_30, LF.CDE_PROD, AR.LIB_30, AR.ORGANE, NA.LIB_50, C.PAYS_PAIE, PP.LIB_50, AC.DESIGNATION,
